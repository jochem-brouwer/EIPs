# bal-devnet-1 spec
:::info
:mega: bal-devnet-1 targets to launch early Jan 2026.
...
**Execution Specs:**  EEST Block-Level Access Lists (BAL) pre-release [v2.0.0](https://github.com/ethereum/execution-spec-tests/releases/tag/bal%40v2.0.0) :heavy_check_mark: :new:
...
participants:
  - cl_type: lodestar
    cl_image: ethpandaops/lodestar:bal-devnet-1
    supernode: true
    el_type: geth
    el_image: ethpandaops/geth:bal-devnet-1
  ...
  - cl_type: lodestar
    ...
    supernode: true
    el_type: besu
    el_image: ethpandaops/besu:bal-devnet-1
  ...
  - cl_type: lodestar
    ...
    supernode: true
    el_type: nethermind
    el_image: ethpandaops/nethermind:bal-devnet-1
    count: 1
  - cl_type: lodestar
    cl_image: ethpandaops/lodestar:bal-devnet-1
    supernode: true
    el_type: nimbus
    el_image: ethpandaops/nimbus-eth1:bal-devnet-1
    count: 1
  - cl_type: lodestar
    cl_image: ethpandaops/lodestar:bal-devnet-1
    supernode: true
    el_type: reth
    el_image: ethpandaops/reth:bal-devnet-1
    count: 1
